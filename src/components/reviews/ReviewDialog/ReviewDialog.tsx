...
const ReviewDialog = memo(function ReviewDialog({ review, onClose }: ReviewDialogProps) {
    ...
    return (<div className={styles.overlay} role="presentation" onClick={handleOverlayClick}>
      <div className={styles.dialog} role="dialog" aria-modal="true" aria-labelledby="review-dialog-title">
        <div className={styles.header}>
          ...
          <button type="button" className={styles.closeButton} aria-label="Закрыть отзыв" onClick={onClose}>
            ×
          </button>
        </div>
