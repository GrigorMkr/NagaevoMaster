      ...
      <div className={pageStyles.page}>
        <div className="container">
          <PageHeader
            ...
            subtitle="6 шагов — с модерацией перед публикацией"
          />
          ...
          <ol className={styles.steps}>
            {STEPS.map((label, i) => (
              <li
                key={label}
                className={i === step ? styles.stepActive : i < step ? styles.stepDone : ''}
              >
                {i + 1}. {label}
              </li>
            ))}
          ...
          <div className={styles.panel}>
            ...
            {step === 2 && (
              <textarea
                ...
                rows={6}
                placeholder="Описание услуги, цена, опыт..."
                aria-label="Описание"
              />
            )}
            ...
            {step === 4 && (
              <p className="textMuted">Предпросмотр карточки перед отправкой</p>
            )}

            {step === 5 && (
              <p>Объявление будет проверено модератором перед публикацией.</p>
            )}
          </div>
