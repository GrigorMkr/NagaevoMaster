    ...
    return (<>
      ...
      <div className={pageStyles.page}>
        <div className="container">
          <PageHeader badge="Профиль" title="Личный кабинет" subtitle="Управление объявлениями и настройками"/>
          ...
          <section className={styles.locationCard} aria-label="Местоположение аккаунта">
            ...
            <div className={styles.locationActions}>
              ...
              {accountLocation && (<Button type="button" variant="outline" onClick={resetLocation}>
                  Сбросить
                </Button>)}
            </div>
          </section>
