...
export const NAGAEVO_CENTER = {
  lat: 54.6247,
  lng: 56.1194,
} as const

export const NAGAEVO_MAP_BOUNDS: [[number, number], [number, number]] = [
  [54.598, 56.068],
  [54.655, 56.155],
]

export const NAGAEVO_STREETS = {
...
export function nagaevoAddress(
  streetKey: keyof typeof NAGAEVO_STREETS,
  house?: string,
  extra?: string,
): ListingLocation {
