...
const boardImage = (file: string) => `${import.meta.env.BASE_URL}images/board/${file}`;
...
const BOARD_KINDS: BoardKindConfig[] = [
  {
    ...
    coverImage: boardImage('sale.png'),
  ...
  },
  {
    ...
    coverImage: boardImage('vacancy.png'),
  ...
  },
  {
    ...
    coverImage: boardImage('lost.png'),
