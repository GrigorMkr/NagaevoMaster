...
const listingsSlice = createSlice({
    ...
    reducers: {
        ...
        setListingsPage(state, action: PayloadAction<{
            page: number;
            totalPages: number;
        }>) {
...
const { setListingsLoading, setListings, setCurrentListing, setListingsPage, setListingsError, } = listingsSlice.actions;
