...
const env = {
  ...
  VK_COMMUNITY_ID: process.env.VK_COMMUNITY_ID,
  VK_VIDEO_URL: process.env.VK_VIDEO_URL,
  VK_VIDEO_OID: process.env.VK_VIDEO_OID,
  VK_VIDEO_ID: process.env.VK_VIDEO_ID,
  VK_VIDEO_HASH: process.env.VK_VIDEO_HASH,
  VK_WALL_POST_OWNER_ID: process.env.VK_WALL_POST_OWNER_ID,
  VK_WALL_POST_ID: process.env.VK_WALL_POST_ID,
  VK_WALL_POST_HASH: process.env.VK_WALL_POST_HASH,
  VK_CONTACT_US_TEXT: process.env.VK_CONTACT_US_TEXT,
  ...
  RUSTORE_PUSH_PROJECT_ID: process.env.RUSTORE_PUSH_PROJECT_ID,
  RUSTORE_PUSH_SERVICE_TOKEN: process.env.RUSTORE_PUSH_SERVICE_TOKEN,
