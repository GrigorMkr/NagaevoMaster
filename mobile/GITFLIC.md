...
- **«timeout of 15000 exceeded»** в веб-консоли RuStore — у их интерфейса таймаут 15 с; APK ~30 МБ не успевает. Обход: стабильный интернет, другой браузер, повтор; или `npm run rustore:deploy` (таймаут 10 мин).
